...
LOCK TABLES `"$P_indicators"` WRITE;
/*!40000 ALTER TABLE `"$P_indicators"` DISABLE KEYS */;
/*!40000 ALTER TABLE `"$P_indicators"` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `O_values` VALUES ('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2019,'toe',150000000),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2018,'toe',149330000),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2021,'toe',151330000),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2017,'toe',148670000),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2020,'toe',150670000),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2019,'Gtoe',0.15000000000000002),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2018,'Gtoe',0.14933000000000002),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2021,'Gtoe',0.15133000000000002),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2017,'Gtoe',0.14867),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2020,'Gtoe',0.15067),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2019,'Mtoe',150),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2018,'Mtoe',149.32999999999998),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2021,'Mtoe',151.32999999999998),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2017,'Mtoe',148.67),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2020,'Mtoe',150.67),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2019,'Ktoe',150000),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2018,'Ktoe',149330),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2021,'Ktoe',151330),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2017,'Ktoe',148670),('Совокупное конечное энергопотребление (Total final consumption)','Природный газ (Natural gas)',2020,'Ktoe',150670);
/*!40000 ALTER TABLE `O_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `P_i`
--
...
--
-- Dumping data for table `P_i`
--

LOCK TABLES `P_i` WRITE;
/*!40000 ALTER TABLE `P_i` DISABLE KEYS */;
INSERT INTO `P_i` VALUES ('Совокупное конечное энергопотребление (Total final consumption)');
/*!40000 ALTER TABLE `P_i` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `P_r` WRITE;
/*!40000 ALTER TABLE `P_r` DISABLE KEYS */;
INSERT INTO `P_r` VALUES ('Природный газ (Natural gas)');
/*!40000 ALTER TABLE `P_r` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `P_y`
--

LOCK TABLES `P_y` WRITE;
/*!40000 ALTER TABLE `P_y` DISABLE KEYS */;
INSERT INTO `P_y` VALUES ('2017'),('2018'),('2019'),('2020'),('2021');
/*!40000 ALTER TABLE `P_y` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 DROP PROCEDURE IF EXISTS `main` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `main`()
BEGIN
  DECLARE Y year;
  DECLARE CY CURSOR FOR SELECT Y FROM P_years;
...
-- Dump completed on 2020-01-04 14:41:22
